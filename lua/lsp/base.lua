...
vim.api.nvim_create_autocmd('LspAttach', {
  ...
  callback = function(ev)
    ...
    nnoremap('<C-k>', vim.lsp.buf.signature_help,
      'LSP: Displays signature information about the symbol under the cursor in a floating window.', opts)
    nnoremap('<leader>wa', vim.lsp.buf.add_workspace_folder,
      'LSP: Add another project root (workspace) to work in, in the current session.', opts)
    ...
    noremap({ 'n', 'v' }, '<leader>ca', vim.lsp.buf.code_action,
